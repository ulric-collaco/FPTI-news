...
export default function HomePage() {
  ...
  const [insightsItem, setInsightsItem] = useState<string | null>(null);
          ...
          {bullets.map((b, i) => {
            ...
            return (
              <div key={i} style={bulletCardStyle}>
                ...
                {/* AI Insights + Email buttons */}
                <div style={{ borderTop: "1px solid #222", paddingTop: "1rem" }}>
                  <div style={{ display: "flex", gap: ".5rem", flexWrap: "wrap" }}>
                    <button
                      onClick={() => setInsightsItem(insightsItem === url ? null : (url || null))}
                      style={{
                        ...buttonStyle,
                        fontSize: "0.85rem",
                        padding: ".5rem .75rem",
                        background: insightsItem === url ? "#111" : "#fff",
                        color: insightsItem === url ? "#fff" : "#000",
                        border: insightsItem === url ? "1px solid #333" : undefined,
                      }}
                      disabled={!url}
                    >
                      🧠 AI Insights
                  ...
                  {insightsItem === url && (
                    <div style={{ fontSize: "0.9rem", lineHeight: 1.6, marginTop: "1rem" }}>
                      {!actions ? (
                        <div style={{ color: "#aaa", display: "flex", alignItems: "center", gap: ".5rem" }}>
                          <Spinner /> Analyzing insights…
                        </div>
                      ) : (
                        <div>
                          {actions.summary && (
                            <div style={{ marginBottom: "0.75rem", color: "#aaa", fontStyle: "italic" }}>
                              {actions.summary}
                            </div>
                          )}
                          ...
                          {actions.affected.length > 0 && (
                            <div style={{ marginBottom: "0.5rem" }}>
                              <strong style={{ color: "#fff" }}>👥 Affected:</strong>
                          ...
                          {actions.actions.length > 0 && (
                            <div style={{ marginBottom: "0.5rem" }}>
                              <strong style={{ color: "#fff" }}>✅ Steps:</strong>
                              <ul style={{ margin: ".5rem 0 0 1.25rem", paddingLeft: 0 }}>
                          ...
                          {actions.relatedRegulations.length > 0 && (
                            <div>
                              <strong style={{ color: "#fff" }}>📚 Related:</strong>
                              <ul style={{ margin: ".5rem 0 0 1.25rem", paddingLeft: 0 }}>
